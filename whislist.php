...
function remove(){
    ...
    $remove_item="DELETE from wishlist where username='$username' AND pro_id='$pro_id'";
    
   $remove_run=mysqli_query($con,$remove_item);
        if($remove_run){
     echo"<script>alert('removed!!')</script>";
    echo"<script>window.open('whislist.php','_self')</script>";
} }
}
...
function wishlist_item(){
    ...
    {
        $username=$_SESSION['username'];
    $get_wish="select * from wishlist where username='$username'";
  ...
  <div class='card-body'>
    ...
    <a href='whislist.php?pro_id=$pro_id' class='btn btn-primary' name='remove'>remove</a>
  </div></div>
</div>";
            }
